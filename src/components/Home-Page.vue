      ...
      >
        ...
        >
          ...
          <div class="filter-section">
            ...
            <button v-if="selectedField" class="clear-button" @click="onClear()">
              پاک کردن
            </button>
          </div>
          <div class="a-filter mb-3">
            <label class="select relative" for="slct">
              ...
              <select id="slct" v-model="selectedField" required="required">
                <option disabled="disabled" value="">یک تخصص انتخاب کنید</option>
